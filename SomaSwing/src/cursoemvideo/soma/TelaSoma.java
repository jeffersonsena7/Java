...
public class TelaSoma extends javax.swing.JFrame {
    ...
    private void btnSomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSomaActionPerformed
        ...
        int n1 = Integer.parseInt(txtN1.getText());//pegando o valor e convertendo
        int n2 = Integer.parseInt(txtN2.getText());//pegando o valor e convertendo
        int soma = n1 + n2;
        lblSoma.setText(Integer.toString(soma)); //enviando e convertendo
